        ...
        while (it.hasNext()) {
            ...
            if (arg.startsWith("-")) {
                if (doneWithSwitches) {
                    ...
                    config.put("type", it.next());
                    it.remove();
                } 
                else if (arg.equals("-v1")) {
                    config.put("verbosity", "quiet");
                } 
                else if (arg.equals("-v2")) {
                    config.put("verbosity", "normal");
                } 
                else if (arg.equals("-v3")) {
                    config.put("verbosity", "loud");
                }
                else if (arg.equals("-nor")) {
                    config.put("recurse", "false");
                }
                else if (arg.equals("-nox")) {
                    config.put("loadExtended", "false");
                }
