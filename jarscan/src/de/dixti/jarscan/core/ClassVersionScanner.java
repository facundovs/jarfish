...
public class ClassVersionScanner implements Scanner {
    ...
    public ClassVersionScanner(String versionString) throws JarScanException {
    ...
    public void scanFile(FileStream fileStream, Result parentResult) throws IOException {
        if(lastParentResult == parentResult) { // archives and toplevel .class-files are only scanned until there is a hit
            return;
        }
